...
* Разработать библиотеку для работы со структурой данных "B-дерево" на любом императивном языке программирования
...
| Параметр    | Описание    |
|-------------|-------------|
| \( n \)     | Количество узлов в B-дереве    |
| \( t \)     | Минимальная степень B-дерева    |
| \( h \)     | Высота B-дерева    |
| Формула     | h ≤ log<sub>t</sub>((n + 1) / 2) |
